...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var buildUrl = "Build";
  var loaderUrl = buildUrl + "/are.loader.js";
  var config = {
    dataUrl: buildUrl + "/a6f0dc72b325df98a6ce6d723ffd5268.data",
    frameworkUrl: buildUrl + "/168e7afe19ed262ca501002ed3fb0066.js",
    codeUrl: buildUrl + "/7b3b4dc28a332c686d2748a29ebc39e3.wasm",
    // #if MEMORY_FILENAME
    memoryUrl: buildUrl + "/",
    // #endif
    // #if SYMBOLS_FILENAME
